...
if(CSTR(Request.QueryString("ID") = 1)) then
rsSanpham_cmd.CommandText = "SELECT * FROM dbo.tbSanPham ORDER BY ID DESC" 
elseif(CSTR(Request.QueryString("ID")) = 2) then
rsSanpham_cmd.CommandText = "SELECT * FROM dbo.tbSanPham ORDER BY ID ASC"
elseif(CSTR(Request.QueryString("ID")) = 3) then
rsSanpham_cmd.CommandText = "SELECT * FROM dbo.tbSanPham ORDER BY GiaSanPham ASC"
elseif(CSTR(Request.QueryString("ID")) = 4) then
rsSanpham_cmd.CommandText = "SELECT * FROM dbo.tbSanPham ORDER BY GiaSanPham DESC"
else
rsSanpham_cmd.CommandText = "SELECT * FROM dbo.tbSanPham ORDER BY ID DESC" 
end if
    ...
    <table border="0">
      <tr>
        <td><% If MM_offset <> 0 Then %>
            <a class="pagesx" id="dell" page="<%=MM_moveFirst%>" sx="<%=Request.QueryString("ID")%>">First</a>
            <% End If ' end MM_offset <> 0 %></td>
        <td><% If MM_offset <> 0 Then %>
            <a class="pagesx" id="dell" page="<%=MM_movePrev%>" sx="<%=Request.QueryString("ID")%>">Previous</a>
            <% End If ' end MM_offset <> 0 %></td>
        <td><% If Not MM_atTotal Then %>
            <a class="pagesx" id="dell" page="<%=MM_moveNext%>" sx="<%=Request.QueryString("ID")%>">Next</a>
            <% End If ' end Not MM_atTotal %></td>
        <td><% If Not MM_atTotal Then %>
            <a class="pagesx" id="dell" page="<%=MM_moveLast%>" sx="<%=Request.QueryString("ID")%>">Last</a>
            <% End If ' end Not MM_atTotal %></td>
      </tr>
    </table>
