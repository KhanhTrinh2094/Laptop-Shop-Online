...
If (Request.QueryString("ID") <> "") Then 
  rsSanpham__MMColParam = Cint(Request.QueryString("ID"))
End If
%>
<%
Dim Hdd1
Dim Hdd2
if((rsSanpham__MMColParam) = 1) then
Hdd1 = "0 GB"
Hdd2 = "100 GB"
elseif((rsSanpham__MMColParam) = 2) then
Hdd1 = "100 GB"
Hdd2 = "300 GB"
elseif((rsSanpham__MMColParam) = 3) then
Hdd1 = "300 GB"
Hdd2 = "600 GB"
elseif((rsSanpham__MMColParam) = 4) then
Hdd1 = "600 GB"
Hdd2 = "10000 GB"
else
Hdd1 = "0 GB"
...
rsSanpham_cmd.CommandText = "SELECT * FROM dbo.tbSanPham WHERE HDD >= ? AND HDD < ?" 
rsSanpham_cmd.Prepared = true
rsSanpham_cmd.Parameters.Append rsSanpham_cmd.CreateParameter("param1", 200, 1, 255, Hdd1) ' adVarChar
rsSanpham_cmd.Parameters.Append rsSanpham_cmd.CreateParameter("param2", 200, 1, 255, Hdd2) ' adVarChar
...
<% if((MM_rsCount) = 0) then %>
   <div class="no-item">
Không có sản phẩm có dung lượng ổ cứng phù hợp
</div>
<% end if %>
...
<table border="0">
  <tr>
    <td><% If MM_offset <> 0 Then %>
        <a class="pagehdd" id="dell" page="<%=MM_moveFirst%>" hdd="<%=Request.QueryString("ID")%>">First</a>
        <% End If ' end MM_offset <> 0 %></td>
    <td><% If MM_offset <> 0 Then %>
        <a class="pagehdd" id="dell" page="<%=MM_movePrev%>" hdd="<%=Request.QueryString("ID")%>">Previous</a>
        <% End If ' end MM_offset <> 0 %></td>
    <td><% If Not MM_atTotal Then %>
        <a class="pagehdd" id="dell" page="<%=MM_moveNext%>" hdd="<%=Request.QueryString("ID")%>">Next</a>
        <% End If ' end Not MM_atTotal %></td>
    <td><% If Not MM_atTotal Then %>
        <a class="pagehdd" id="dell" page="<%=MM_moveLast%>" hdd="<%=Request.QueryString("ID")%>">Last</a>
        <% End If ' end Not MM_atTotal %></td>
  </tr>
</table>
</div>
