...
rsSanpham_cmd.CommandText = "SELECT * FROM dbo.tbSanPham WHERE TenSanPham LIKE '%' + ? + '%'"
rsSanpham_cmd.Prepared = true
rsSanpham_cmd.Parameters.Append rsSanpham_cmd.CreateParameter("param1", 202, 1, 50, Request.QueryString("search")) ' adVarWChar
rsSanpham_cmd.Prepared = true
    ...
    <table border="0">
      <tr>
        <td><% If MM_offset <> 0 Then %>
            <a class="pagetk" id="dell" page="<%=MM_moveFirst%>" tk="<%=Request.QueryString("search")%>">First</a>
            <% End If ' end MM_offset <> 0 %></td>
        <td><% If MM_offset <> 0 Then %>
            <a class="pagetk" id="dell" page="<%=MM_movePrev%>" tk="<%=Request.QueryString("search")%>">Previous</a>
            <% End If ' end MM_offset <> 0 %></td>
        <td><% If Not MM_atTotal Then %>
            <a class="pagetk" id="dell" page="<%=MM_moveNext%>" tk="<%=Request.QueryString("search")%>">Next</a>
            <% End If ' end Not MM_atTotal %></td>
        <td><% If Not MM_atTotal Then %>
            <a class="pagetk" id="dell" page="<%=MM_moveLast%>" tk="<%=Request.QueryString("search")%>">Last</a>
            <% End If ' end Not MM_atTotal %></td>
      </tr>
    </table>
