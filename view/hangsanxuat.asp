...
<% if((MM_rsCount) = 0) then %>
   <div class="no-item">
Không có sản phẩm thuộc hãng sản xuất này
</div>
<% end if %>
...
<table border="0">
  <tr>
    <td><% If MM_offset <> 0 Then %>
        <a class="pagehsx" id="dell" page="<%=MM_moveFirst%>" hsx="<%=Request.QueryString("ID")%>">First</a>
        <% End If ' end MM_offset <> 0 %></td>
    <td><% If MM_offset <> 0 Then %>
        <a class="pagehsx" id="dell" page="<%=MM_movePrev%>" hsx="<%=Request.QueryString("ID")%>">Previous</a>
        <% End If ' end MM_offset <> 0 %></td>
    <td><% If Not MM_atTotal Then %>
        <a class="pagehsx" id="dell" page="<%=MM_moveNext%>" hsx="<%=Request.QueryString("ID")%>">Next</a>
        <% End If ' end Not MM_atTotal %></td>
    <td><% If Not MM_atTotal Then %>
        <a class="pagehsx" id="dell" page="<%=MM_moveLast%>" hsx="<%=Request.QueryString("ID")%>">Last</a>
        <% End If ' end Not MM_atTotal %></td>
  </tr>
</table>
</div>
