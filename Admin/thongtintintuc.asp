                    ...
                    <div class="span12">
                        ...
                        <div class="block-fluid">                        
                            <div class="row-form clearfix">
                                ...
                                <div class="span9"><%=(rsTintuc.Fields.Item("TieuDe").Value)%></div>
                            </div>
                          <div class="row-form clearfix">
                                <div class="span3">Nội dung:</div>
                                <div class="span9" style="height: 800px"><textarea style="height: 800px" id="wysiwyg" name="wysiwyg" disabled><%=(rsTintuc.Fields.Item("NoiDung").Value)%></textarea></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Thao tác:</div>
                                <div class="span9"><a href="suatintuc.asp?id=<%=(rsTintuc.Fields.Item("ID").Value)%>"><button class="btn" type="button">Sửa</button></a> <a href="xoatintuc.asp?id=<%=(rsTintuc.Fields.Item("ID").Value)%>"><button class="btn btn-danger" type="button">Xóa</button></a></div>
                            </div>
                       </div>
                   </div>
               </div>
