...
rsHSX__MMColParam = "1"
If (Application("HSXID") <> "") Then 
  rsHSX__MMColParam = Application("HSXID")
End If
%>
<%
Dim rsHSX
...
rsHSX_cmd.CommandText = "SELECT TenHang FROM dbo.tbHangSanXuat WHERE ID = ?" 
rsHSX_cmd.Prepared = true
rsHSX_cmd.Parameters.Append rsHSX_cmd.CreateParameter("param1", 5, 1, -1, (rsSanpham.Fields.Item("HSXID").Value)) ' adDouble
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        <div class="head clearfix">
                            ...
                            <h1>Sản phẩm : <%=(rsSanpham.Fields.Item("TenSanPham").Value)%></h1>
                        </div>
                        <div class="block-fluid">                        
                            <div class="row-form clearfix">
                                <div class="span3">Tên sản phẩm:</div>
                                <div class="span9"><%=(rsSanpham.Fields.Item("TenSanPham").Value)%></div>
                            </div>
                            <div class="row-form clearfix">
                            ...
                            <div class="row-form clearfix">
                                <div class="span3">Ram:</div>
                                <div class="span9"><%=(rsSanpham.Fields.Item("Ram").Value)%></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">HDD:</div>
                                <div class="span9"><%=(rsSanpham.Fields.Item("HDD").Value)%></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Chip:</div>
                                <div class="span9"><%=(rsSanpham.Fields.Item("Chip").Value)%></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Trạng thái:</div>
                                <div class="span9"><% if ((rsSanpham.Fields.Item("TrangThai").Value) = 1) then %>
                                Còn hàng
								<% Else %>
                                Hết hàng
							  <% end if %></div>
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span9"><%=(rsSanpham.Fields.Item("GiaSanPham").Value)%></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Ảnh:</div>
                                <div class="span9"><img src="../thumb/<%=(rsSanpham.Fields.Item("Anh").Value)%>" alt="thumb" /></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Chi tiết sản phẩm:</div>
                                <div class="span9"><textarea id="wysiwyg" name="wysiwyg"><%=(rsSanpham.Fields.Item("ChiTiet").Value)%></textarea></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Thao tác:</div>
                                <div class="span9"><a href="suasanpham.asp?id=<%=(rsSanpham.Fields.Item("ID").Value)%>"><button class="btn" type="button">Sửa</button></a> <a href="xoasanpham.asp?id=<%=(rsSanpham.Fields.Item("ID").Value)%>"><button class="btn btn-danger" type="button">Xóa</button></a></div>
                            </div>
                       </div>
                   </div>
               </div>
