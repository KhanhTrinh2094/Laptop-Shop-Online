                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        <div class="head clearfix">
                            ...
                            <h1>Khách hàng : <%=(rsKhachhang.Fields.Item("TenDangNhap").Value)%></h1>
                        </div>
                        <div class="block-fluid">                        
                            <div class="row-form clearfix">
                                <div class="span3">Tên đăng nhập:</div>
                                <div class="span9"><%=(rsKhachhang.Fields.Item("TenDangNhap").Value)%></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Họ và tên:</div>
                                <div class="span9"><%=(rsKhachhang.Fields.Item("Hoten").Value)%></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Địa chỉ:</div>
                                <div class="span9"><%=(rsKhachhang.Fields.Item("DiaChi").Value)%></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Email:</div>
                                <div class="span9"><%=(rsKhachhang.Fields.Item("Email").Value)%></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Số điện thoại:</div>
                                <div class="span9"><%=(rsKhachhang.Fields.Item("SoDienThoai").Value)%></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Giới tính:</div>
                                <div class="span9"><% if(rsKhachhang.Fields.Item("GioiTinh").Value) = True Then
	  response.write("Nam")
	  Else
response.write("Nữ")
End If
%></div>
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span9"><% if(rsKhachhang.Fields.Item("TrangThai").Value) = 1 Then
...
%></div>
	  ...
	  <a href="suathanhvien.asp?id=<%=(rsKhachhang.Fields.Item("ID").Value)%>&action=lock"><button class="btn" type="button">Khóa</button></a>
<%	  Else %>
<a href="suathanhvien.asp?id=<%=(rsKhachhang.Fields.Item("ID").Value)%>&action=unlock"><button class="btn" type="button">Kích hoạt</button></a>
<% End If %>
 <a href="xoathanhvien.asp?id=<%=(rsKhachhang.Fields.Item("ID").Value)%>"><button class="btn btn-danger" type="button">Xóa</button></a></div>
                            </div>
                       </div>
                   </div>
               </div>
