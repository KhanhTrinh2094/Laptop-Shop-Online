...
If (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "DELETE FROM dbo.tbBinhLuan WHERE ID = ?"
    ...
    MM_editRedirectUrl = "quanlybinhluan.asp?delete=ok"
    If (Request.QueryString <> "") Then
...
rsBinhluan_cmd.CommandText = "SELECT * FROM dbo.tbBinhLuan WHERE ID = ?" 
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                      ...
                      <div class="row-form clearfix">
                        <div class="span12" align="center"><h3>Bạn có chắc chắn muốn xóa bình luận này ?</h3><br />
<form name="form1" method="POST" action="<%=MM_editAction%>">
    <input name="ID" type="hidden" id="ID" value="<%=(rsBinhluan.Fields.Item("ID").Value)%>">
    <input type="submit" name="submit" id="submit" value="Đồng ý">
    <input type="hidden" name="MM_delete" value="form1">
    <input type="hidden" name="MM_recordId" value="<%= rsBinhluan.Fields.Item("ID").Value %>">
</form>
<a href="quanlybinhluan.asp"><input type="button" value="Hủy bỏ"/></a>
</div>
</div>
</div>
<!-- InstanceEndEditable -->
