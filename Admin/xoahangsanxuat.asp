...
If (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "DELETE FROM dbo.tbHangSanXuat WHERE ID = ?"
    ...
    MM_editRedirectUrl = "quanlyhangsanxuat.asp?delete=ok"
    If (Request.QueryString <> "") Then
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                      ...
                      <div class="row-form clearfix">
                        ...
                        <% if(rsCount.Fields.Item("num").Value) then %>
                        <h3>Xin lỗi. Bạn không thể xóa. Đang có <%=(rsCount.Fields.Item("num").Value)%> sản phẩm thuộc hãng sản xuất này. Vui lòng xóa các sản phẩm trước khi xóa hãng sản xuất</h3><br />
                        <a href="quanlyhangsanxuat.asp"><input type="button" value="Quay lại"/></a>
                        <% else %>
                        <h3>Bạn có chắc chắn muốn xóa hãng sản xuất : <%=(rsHSX.Fields.Item("TenHang").Value)%></h3><br />
<form name="form1" method="POST" action="<%=MM_editAction%>">
    <input name="ID" type="hidden" id="ID" value="<%=(rsHSX.Fields.Item("ID").Value)%>">
...
<a href="quanlyhangsanxuat.asp"><input type="button" value="Hủy bỏ"/></a>
<% end if %>
</div>
</div>
</div>
