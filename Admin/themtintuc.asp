...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.tbTinTuc (TieuDe, NoiDung, Anh) VALUES (?, ?, ?)" 
    ...
    MM_editRedirectUrl = "quanlytintuc.asp?insert=ok"
    If (Request.QueryString <> "") Then
...
<form action="<%=MM_editAction%>" method="POST" name="form1" onsubmit="return kt()">                        
                            <div class="row-form clearfix">
                                ...
                                <div class="span9"><input type="text" name="txtTieude" id="txtTieude" placeholder="Nhập tiêu đề tin tức" required/></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Nội dung:</div>
                              <div class="span9"><textarea id="wy" name="wy" style="height: 500px;" required></textarea></div>
                            </div>
                            <div class="row-form clearfix">
