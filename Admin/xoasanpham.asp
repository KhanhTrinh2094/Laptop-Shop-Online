...
If (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "DELETE FROM dbo.tbSanPham WHERE ID = ?"
    ...
    MM_editRedirectUrl = "quanlysanpham.asp?delete=ok"
    If (Request.QueryString <> "") Then
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                      ...
                      <div class="row-form clearfix">
                        <div class="span12" align="center"><h3>Bạn có chắc chắn muốn xóa sản phẩm : <%=(rsSanpham.Fields.Item("TenSanPham").Value)%></h3><br />
<form name="form1" method="POST" action="<%=MM_editAction%>">
    <input name="ID" type="hidden" id="ID" value="<%=(rsSanpham.Fields.Item("ID").Value)%>">
...
<a href="quanlysanpham.asp"><input type="button" value="Hủy bỏ"/></a>
</div>
</div>
</div>
<!-- InstanceEndEditable -->
