...
rsSanpham_cmd.CommandText = "SELECT A.ID, A.TenSanPham, A.Chip, A.HDD, A.Ram, B.TenHang, A.GiaSanPham, A.TrangThai FROM tbSanPham A INNER JOIN tbHangSanXuat B ON A.HSXID = B.ID ORDER BY ID DESC" 
...
<!-- InstanceBeginEditable name="EditRegion3" -->
		<script type="text/javascript" charset="utf-8">
			$(document).ready(function() {
                ...
                <% end if %>
                <% if((Request.QueryString("insert")) = "ok") then %>
                <div class="alert alert-success">                
                    <h4>Thành công!</h4>
  ...
  <% While ((Repeat1__numRows <> 0) AND (NOT rsSanpham.EOF)) %>
                                    <tr>
                                        ...
                                        <td><%=(rsSanpham.Fields.Item("TenHang").Value)%></td>
