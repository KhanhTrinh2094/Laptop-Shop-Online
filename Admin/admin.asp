...
rsAdmin_cmd.CommandText = "SELECT ID, TenDangNhap FROM dbo.tbKhachHang WHERE VaiTro = 1" 
...
Admin <small>List</small></h1>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="table">
                                                <thead>
                                    <tr>
                                        <th width="16%"><input type="checkbox" name="checkall"/></th>
                                        <th width="21%">ID</th>
                                        <th width="63%">Tên đăng nhập</th>                                   
                                    </tr>
                                </thead>
                        <% While ((Repeat1__numRows <> 0) AND (NOT rsAdmin.EOF)) %>
                          <tr>
                            <td><input type="checkbox" name="checkbox"/></td>
                            <td><%=(rsAdmin.Fields.Item("ID").Value)%></td>
                            <td><%=(rsAdmin.Fields.Item("TenDangNhap").Value)%></td>
                          </tr>
                          <% 
