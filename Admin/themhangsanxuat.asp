...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.tbHangSanXuat (TenHang, Web, LoGo) VALUES (?, ?, ?)" 
    ...
    MM_editRedirectUrl = "quanlyhangsanxuat.asp?inser=ok"
    If (Request.QueryString <> "") Then
...
<form action="<%=MM_editAction%>" method="POST" name="form1" onsubmit="return kt()">                        
                            <div class="row-form clearfix">
                                ...
                                <div class="span9"><input type="text" name="txtHang" id="txtHang" placeholder="Nhập tên hãng sản xuất" required/></div>
                            </div>
                            <div class="row-form clearfix">
                                <div class="span3">Trang Web:</div>
                              <div class="span3"><input type="text" name="txtWeb" id="txtWeb" placeholder="Nhập trang Web" required/></div>
                            </div>
                            <div class="row-form clearfix">
