...
rsPhanhoi_cmd.CommandText = "SELECT a.*, b.TenDangNhap FROM tbPhanHoi a INNER JOIN tbKhachHang b ON a.KHID = b.ID" 
                    ...
                    <div class="span12">                    
                        ...
                        <div class="block-fluid table-sorting clearfix">
                            <table cellpadding="0" cellspacing="0" width="100%" class="table" id="example">
                                ...
                                <tbody>
  <% While ((Repeat1__numRows <> 0) AND (NOT rsPhanhoi.EOF)) %>
    <tr>
      <td><%=(rsPhanhoi.Fields.Item("ID").Value)%></td>
      <td><a href="thongtinphanhoi.asp?id=<%=(rsPhanhoi.Fields.Item("ID").Value)%>"><%=(rsPhanhoi.Fields.Item("TieuDe").Value)%></a></td>
      <td><a href="thongtinthanhvien.asp?id=<%=(rsPhanhoi.Fields.Item("KHID").Value)%>"><%=(rsPhanhoi.Fields.Item("TenDangNhap").Value)%></a></td>
      <td><%=(rsPhanhoi.Fields.Item("ThoiGian").Value)%></td>
      <td><%=left((rsPhanhoi.Fields.Item("NoiDung").Value), 450)%> ... <a href="thongtinphanhoi.asp?id=<%=(rsPhanhoi.Fields.Item("ID").Value)%>">xem tiếp</a></td>
      <td><center><a href="xoaphanhoi.asp?id=<%=(rsPhanhoi.Fields.Item("ID").Value)%>"><button class="btn btn-danger" type="button">Xóa</button></a></center></td>
    </tr>
    <% 
