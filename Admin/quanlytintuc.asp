...
<!-- InstanceBeginEditable name="EditRegion3" -->
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">                    
                        <div class="head clearfix">
                            ...
                            <h1>Quản lý tin tức</h1>
                            <ul class="buttons">
                                <li><a href="themtintuc.asp" class="isw-plus"></a></li>
  ...
  <% While ((Repeat1__numRows <> 0) AND (NOT rsTintuc.EOF)) %>
                                    <tr>
                                    	<td><%=(rsTintuc.Fields.Item("ID").Value)%></td>
                                        <td><a href="thongtintintuc.asp?id=<%=(rsTintuc.Fields.Item("ID").Value)%>"><%=(rsTintuc.Fields.Item("TieuDe").Value)%></a></td>
                                        <td><img src="../thumb/Tintuc/<%=(rsTintuc.Fields.Item("Anh").Value)%>" alt="tin tức" height="30px;" width="120px"/></td>
                                        <td><%=left((rsTintuc.Fields.Item("NoiDung").Value), 450)%> ... <a href="thongtintintuc.asp?id=<%=(rsTintuc.Fields.Item("ID").Value)%>">chi tiết</a></td>
                                        <td><div class="btn-group" align="center">                                        
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="suatintuc.asp?id=<%=(rsTintuc.Fields.Item("ID").Value)%>">Sửa</a></li>
                                                
                                                <li class="divider"></li>
                                                
                                                <li><a href="xoatintuc.asp?id=<%=(rsTintuc.Fields.Item("ID").Value)%>">Xóa</a></li>
                                            </ul>
                                        </div></td>
                                    </tr>
    <% 
